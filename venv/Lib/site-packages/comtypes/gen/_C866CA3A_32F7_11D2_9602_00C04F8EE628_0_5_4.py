...
__all__ = [
    'ISpeechPhraseElements', 'SPPS_Noncontent', 'SRERecoOtherContext',
    'tagSPPROPERTYINFO', 'SRSEDone', 'SPEI_WORD_BOUNDARY', 'SVPOver',
    'DISPID_SDKSetBinaryValue', 'SPVPRI_OVER', 'SDKLCurrentUser',
    'SPLO_STATIC', 'DISPID_SRRTOffsetFromStart',
    'SRSInactiveWithPurge', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SCSBaseStream', 'ISpNotifyTranslator', 'SRAInterpreter',
    'ISpeechGrammarRule', 'SGDSActiveWithAutoPause',
    'DISPID_SVPriority', 'SAFTADPCM_8kHzMono', 'DISPID_SAVolume',
    'IInternetSecurityManager', 'SLOStatic',
    'DISPID_SRCEventInterests', 'DISPID_SGRClear',
    'SpeechTokenIdUserLexicon', 'SpSharedRecognizer', 'SRTAutopause',
    'SPRST_NUM_STATES', 'SPVISEMES', 'SpeechRegistryUserRoot',
    'SRTStandard', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPEEngineConfidence', 'SPCATEGORYTYPE',
    'SGPronounciation', 'DISPID_SRCEHypothesis', 'SDTDisplayText',
    'SpeechLexiconType', 'SAFT32kHz16BitMono', 'DISPID_SPIRule',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPSMF_SAPI_PROPERTIES', 'ISpObjectToken', 'SPAO_RETAIN_AUDIO',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRGetXMLResult',
    'DISPID_SLPs_NewEnum', 'SVP_15', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRSRule', 'SPDKL_CurrentUser', 'SPDKL_CurrentConfig',
    'SpObjectTokenCategory', 'SP_VISEME_10', 'SREAllEvents',
    'SPEI_MAX_SR', 'ISpPhoneConverter', 'SPINTERFERENCE',
    'SpMMAudioOut', 'DISPID_SpeechRecoContextEvents',
    'SDTReplacement', 'DISPID_SRRTLength', 'SpeechDiscardType',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SDKGetBinaryValue',
    'SPSERIALIZEDPHRASE', 'SVSFPersistXML', 'DISPID_SPELexicalForm',
    'SpeechRecoProfileProperties', 'SpeechRecognitionType',
    'DISPID_SRRRecoContext', 'SVEAllEvents', 'SVP_3',
    'SAFT11kHz16BitMono', 'DISPID_SVSInputSentenceLength',
    'WAVEFORMATEX', 'SAFTCCITT_uLaw_11kHzMono', 'SPCT_SLEEP',
    'SGDisplay', 'DISPID_SLPType', 'ISpeechLexiconWords',
    'SpeechLoadOption', 'DISPID_SRCERecognizerStateChange',
    'SP_VISEME_16', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRGetRecognizers', 'SLTApp', 'DISPID_SGRsCommit',
    'DISPID_SPPId', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SREPropertyStringChange', 'DISPID_SRDisplayUI', 'SRESoundStart',
    'DISPID_SpeechPhraseReplacements', 'ISpeechRecoGrammar',
    'DISPID_SPIElements', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT11kHz8BitMono',
    'SPSHT_EMAIL', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SVSVisemeId', 'SPEI_INTERFERENCE',
    'DISPID_SpeechPhraseElements', 'SSSPTRelativeToCurrentPosition',
    'SASStop', 'DISPID_SVAlertBoundary', 'SASRun',
    'DISPID_SpeechObjectTokenCategory', 'SPSMF_UPS', 'SpShortcut',
    'DISPID_SpeechPhraseReplacement', 'SP_VISEME_7',
    'SpeechStreamFileMode', 'SPDATAKEYLOCATION', 'SPSVerb',
    'SP_VISEME_17', 'DISPID_SBSFormat', 'IStream', 'SPPS_RESERVED3',
    'SpeechGrammarWordType', 'SPINTERFERENCE_TOOSLOW',
    'SRSActiveAlways', 'DISPID_SGRSTText', 'DISPID_SRGState',
    'SECFIgnoreCase', 'DISPID_SLWType', 'DISPID_SRRSpeakAudio',
    'ISpeechGrammarRuleState', 'SRAImport', 'SpInprocRecognizer',
    'ISpeechMMSysAudio', 'DISPID_SRGCommit', 'SPWF_INPUT',
    'DISPID_SOTCreateInstance', 'SGSExclusive', 'SP_VISEME_2',
    'SITooFast', 'DISPID_SRSetPropertyNumber',
    'DISPID_SWFEBitsPerSample', 'SITooSlow',
    'DISPID_SPEPronunciation', 'DISPID_SPRsCount', 'DISPID_SPPsItem',
    'ISpeechBaseStream', 'SPAS_CLOSED', 'DISPID_SPRNumberOfElements',
    'SPEI_SOUND_END', 'SPEI_RESERVED3', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SASetState', 'SPCT_SUB_DICTATION',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechVoice',
    'DISPID_SAEventHandle', 'SpCustomStream', 'DISPID_SRCState',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRCEAdaptation',
    'DISPID_SGRId', 'DISPID_SPAPhraseInfo', 'DISPID_SGRs_NewEnum',
    'DISPID_SGRName', 'eLEXTYPE_PRIVATE19', 'SVPAlert',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPPARTOFSPEECH',
    'SpeechCategoryAudioIn', 'SPRECORESULTTIMES',
    'SpeechTokenValueCLSID', 'SPSHT_NotOverriden',
    'DISPID_SABufferInfo', 'DISPID_SVEWord', 'SAFT48kHz16BitStereo',
    'SPFM_CREATE_ALWAYS', 'DISPID_SGRsItem', 'DISPID_SPISaveToMemory',
    'ISpeechXMLRecoResult', 'eLEXTYPE_PRIVATE13',
    'SpeechRegistryLocalMachineRoot', 'SFTInput', 'ISpNotifySource',
    'SAFTGSM610_8kHzMono', 'SPEI_FALSE_RECOGNITION', 'ISpShortcut',
    'ISpeechLexicon', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechGrammarRule', 'DISPID_SLWsCount',
    'SDKLCurrentConfig', 'DISPID_SOTGetDescription',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE5',
    'SAFT12kHz8BitStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechTextSelectionInformation', 'DISPID_SGRInitialState',
    'DISPID_SRCSetAdaptationData', 'SP_VISEME_1', 'SpeechMicTraining',
    'SP_VISEME_11', 'SPRS_INACTIVE', 'SAFT22kHz16BitStereo',
    'DISPID_SVWaitUntilDone', 'DISPID_SVGetAudioOutputs', 'SVSFIsXML',
    'eLEXTYPE_PRIVATE4',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRAudioInput', 'SVP_18', 'DISPID_SVIsUISupported',
    'SPSLMA', 'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT44kHz8BitStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTCDefault', 'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_14',
    'SPPHRASE', 'SREStreamEnd', 'SpVoice', 'DISPID_SVSpeak',
    'SREStreamStart', 'DISPID_SPPValue', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SMSADeviceId', 'SPRST_INACTIVE', 'SVSFVoiceMask',
    'SGRSTTWildcard', 'SPTEXTSELECTIONINFO', 'SECFIgnoreKanaType',
    'SVF_Emphasis', 'SSFMOpenReadWrite', 'ISpeechVoice',
    'DISPID_SpeechRecoResult', '_ISpeechVoiceEvents',
    'SDTLexicalForm', 'DISPID_SRCCreateResultFromMemory',
    'Speech_Max_Word_Length', 'DISPID_SpeechCustomStream',
    'DISPID_SRGRules', 'DISPID_SPRs_NewEnum',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechVoiceStatus',
    'SpeechTokenKeyFiles', 'SSTTWildcard', 'SP_VISEME_6',
    'SPVPRIORITY', 'DISPID_SRCBookmark', 'SpeechDataKeyLocation',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPPName', 'ISpPhraseAlt', 'SVP_17',
    'DISPID_SPEAudioSizeBytes', 'SWTDeleted', 'eLEXTYPE_RESERVED6',
    'SPEI_START_SR_STREAM', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SRTSMLTimeout', 'SDTRule', 'SFTSREngine', 'SPGS_EXCLUSIVE',
    'SPPS_RESERVED2', 'DISPID_SVDisplayUI', 'eLEXTYPE_RESERVED7',
    'SPEI_VISEME', 'SGRSTTTextBuffer', 'SVP_14', 'SPFILEMODE',
    'DISPID_SVEventInterests', 'DISPID_SpeechPhraseInfo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPWORDTYPE', 'SpeechFormatType',
    'DISPID_SAFType', 'DISPID_SPPFirstElement', 'SRTExtendableParse',
    'DISPID_SPERetainedSizeBytes', 'SAFT22kHz8BitMono',
    'SPFM_OPEN_READWRITE', 'SpeechCategoryAppLexicons',
    'SVSFParseSsml', 'eLEXTYPE_RESERVED4', 'SPPHRASEELEMENT',
    'DISPID_SpeechMemoryStream', 'SPBO_NONE',
    'SpeechEmulationCompareFlags', 'DISPID_SPRDisplayAttributes',
    'ISpeechAudioStatus', 'DISPID_SVPause', 'SPXMLRESULTOPTIONS',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SASState', 'eLEXTYPE_USER', 'SpeechAddRemoveWord',
    'DISPID_SpeechPhraseProperty', 'SRARoot',
    'DISPID_SRSCurrentStreamPosition', 'SRCS_Disabled',
    'SPVPRI_ALERT', 'SVP_9', 'LONG_PTR', 'DISPID_SABIEventBias',
    'DISPID_SOTCGetDataKey', 'SPBO_AHEAD', 'SREAudioLevel',
    'DISPID_SRStatus', 'DISPID_SpeechPhraseRule', 'SGSEnabled',
    'DISPID_SRIsShared', 'SPPHRASERULE', 'SPFM_NUM_MODES',
    'SpeechAudioFormatGUIDText', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRRTimes', 'DISPID_SPIGrammarId', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPIProperties', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SOTId',
    'SAFT8kHz16BitStereo', 'DISPID_SPRuleFirstElement',
    'DISPID_SDKDeleteKey', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SGRSAddRuleTransition', 'SGDSInactive',
    'SAFT32kHz8BitStereo', 'eLEXTYPE_VENDORLEXICON', 'SPEVENTENUM',
    'SREHypothesis', 'SPAR_High', 'SpMMAudioEnum',
    'SAFTGSM610_11kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRSTs_NewEnum', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE20', 'ISpeechCustomStream',
    'SpTextSelectionInformation', 'SREFalseRecognition',
    'SAFT12kHz16BitMono', 'ISpRecognizer', 'DISPID_SRRPhraseInfo',
    'SP_VISEME_19', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechMMSysAudio', 'ISpDataKey', 'DISPID_SGRsFindRule',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGRecoContext',
    'SpeechDictationTopicSpelling', 'SpeechRecoContextState',
    'DISPID_SLGenerationId', 'ISpeechObjectTokenCategory',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCEBookmark',
    'SPPS_Function', 'DISPID_SOTSetId', 'DISPID_SAStatus',
    'DISPID_SpeechRecognizerStatus', 'SAFT12kHz8BitMono',
    'SP_VISEME_3', 'SPBO_TIME_UNITS', 'SAFTExtendedAudioFormat',
    'DISPID_SLPsCount', 'ISpeechPhraseInfoBuilder', 'SVP_21',
    'SpeechWordType', 'SpeechUserTraining', 'SPAUDIOOPTIONS',
    'DISPID_SOTCId', 'SDA_No_Trailing_Space', 'SAFT44kHz16BitStereo',
    'DISPID_SGRSTPropertyId', 'SPEVENTSOURCEINFO',
    'DISPID_SRRSaveToMemory', 'SSSPTRelativeToStart',
    'eWORDTYPE_ADDED', 'SINone', 'DISPID_SMSAMMHandle',
    'SPEI_START_INPUT_STREAM', 'SPGS_DISABLED', 'SpWaveFormatEx',
    'DISPID_SLWPronunciations', 'SpInProcRecoContext', 'SRAExport',
    'DISPID_SVEVoiceChange', 'DISPID_SPACommit', 'SVSFDefault',
    'DISPID_SVVolume', 'SAFT12kHz16BitStereo', 'SVEPrivate',
    'DISPID_SLPsItem', 'SPSFunction', 'DISPID_SFSClose',
    'DISPID_SRGetFormat', 'DISPID_SPCLangId',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPRsItem', 'SVP_1',
    'SpStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'eLEXTYPE_RESERVED9', 'DISPID_SASNonBlockingIO', 'DISPID_SBSSeek',
    'DISPID_SRIsUISupported', 'ISpeechRecoResultTimes',
    'DISPID_SGRSTPropertyName', 'DISPID_SDKEnumValues',
    'SPWORDPRONUNCIATION', 'SPPS_Noun', 'SpObjectToken',
    'ISpeechPhraseAlternates', 'eLEXTYPE_PRIVATE11',
    'SpeechEngineConfidence', 'ISpeechLexiconPronunciation',
    'ISpeechRecoResult', 'SPEI_RESERVED6', 'SAFT8kHz16BitMono',
    'SVEEndInputStream', 'DISPID_SpeechGrammarRules',
    'SVEStartInputStream', 'DISPID_SRCreateRecoContext',
    'DISPID_SPRText', 'SVSFParseSapi', 'SAFTADPCM_22kHzMono',
    'DISPID_SVSLastBookmark', 'DISPID_SVEPhoneme',
    'DISPID_SABIBufferSize', 'SPSHORTCUTPAIRLIST', 'DISPID_SPAsItem',
    'DISPID_SVSLastBookmarkId', 'SpeechPropertyResourceUsage',
    'eLEXTYPE_RESERVED10', 'SRSEIsSpeaking', 'SBONone',
    'ISpeechPhraseAlternate', 'ISpRecoContext2', 'ISpSerializeState',
    'DISPID_SGRSTransitions', 'DISPID_SVSRunningState',
    'SVF_Stressed', 'SPRS_ACTIVE', 'SITooLoud', 'SVPNormal',
    'SVSFUnusedFlags', 'SECFIgnoreWidth', 'SAFTText', 'SRAONone',
    'SREInterference', 'ISpRecoGrammar', 'DISPID_SPRuleId',
    'DISPID_SRGDictationUnload', 'DISPID_SPEAudioTimeOffset',
    'SRTReSent', 'tagSTATSTG', 'SPINTERFERENCE_TOOFAST', 'SVP_12',
    'DISPID_SOTCEnumerateTokens', 'SPBO_PAUSE', 'SAFT48kHz8BitStereo',
    'SINoise', 'SpeechRetainedAudioOptions',
    'DISPID_SRGSetTextSelection', 'DISPID_SDKEnumKeys', 'SGRSTTWord',
    'DISPID_SRGReset', 'SGRSTTRule', 'SP_VISEME_4',
    'SPPS_Interjection', 'DISPID_SRCEEndStream', 'SpMemoryStream',
    'SAFTNonStandardFormat', 'DISPID_SRRTStreamTime', 'ISpLexicon',
    'DISPIDSPRG', 'SPSHT_OTHER', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechVisemeType', 'SPEI_SR_PRIVATE', 'SRERequestUI',
    'SAFT8kHz8BitMono', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechLexiconPronunciation', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechEngineProperties',
    'DISPID_SpeechBaseStream', 'SpeechRunState',
    'SpeechCategoryVoices', 'DISPID_SASCurrentDevicePosition',
    'ISpeechObjectTokens', 'SPEI_SOUND_START', 'SPCT_DICTATION',
    ...
    'eLEXTYPE_PRIVATE3', 'ISpGrammarBuilder', 'SPRECOGNIZERSTATUS',
    'DISPID_SABIMinNotification', 'DISPID_SpeechPhraseRules',
    'ISpVoice', 'SITooQuiet', 'SPSInterjection',
    'SGDSActiveUserDelimited', 'ISpeechMemoryStream',
    'SAFT24kHz16BitMono', 'SPSERIALIZEDRESULT', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVEStreamEnd', 'DISPID_SASCurrentSeekPosition',
    'SpeechCategoryPhoneConverters', 'DISPID_SBSWrite',
    'IEnumSpObjectTokens', 'DISPID_SPEsItem', 'SP_VISEME_15',
    'SVP_20', 'DISPID_SRCEAudioLevel', 'SAFT16kHz16BitMono',
    'SpeechWordPronounceable', 'ISpeechRecoContext',
    'SECFEmulateResult', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPCT_SUB_COMMAND', 'SVSFIsNotXML',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPINTERFERENCE_TOOQUIET',
    'SAFT44kHz16BitMono', 'ISpeechPhraseReplacement', '_SPAUDIOSTATE',
    'ISpeechAudioFormat', 'DISPID_SPRFirstElement', 'SPSNoun',
    'SPLOADOPTIONS', 'DISPID_SpeechObjectToken', 'SBOPause', 'SDTAll',
    'SPVPRI_NORMAL', 'DISPID_SGRAddResource', 'SPADAPTATIONRELEVANCE',
    'SVEPhoneme', 'DISPID_SPIReplacements', 'SPPS_RESERVED4',
    'ISpObjectTokenCategory', 'SpeechCategoryRecognizers', 'SLTUser',
    'DISPID_SPEActualConfidence', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCPause',
    'SpeechAllElements', 'DISPID_SVSCurrentStreamNumber',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT24kHz16BitStereo',
    'SVP_19', 'DISPID_SRCEPhraseStart', 'DISPID_SpeechVoiceStatus',
    'SpeechAudioProperties', 'ISpPhrase', 'SPSSuppressWord',
    'SAFT44kHz8BitMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPAR_Medium', 'SpeechGrammarTagDictation',
    'DISPID_SVAudioOutput', 'SpeechVoiceSpeakFlags',
    'SPEI_HYPOTHESIS', 'DISPID_SDKCreateKey', 'SpeechTokenKeyUI',
    'UINT_PTR', 'DISPID_SRSetPropertyString', 'SPEI_ADAPTATION',
    'SPEI_RESERVED1', 'DISPID_SPRuleParent', 'SPCONTEXTSTATE',
    'SVSFNLPMask', 'SAFT8kHz8BitStereo', 'SpeechAudioVolume',
    'SVEWordBoundary', 'DISPID_SRGetPropertyString',
    'SpNullPhoneConverter', 'DISPID_SADefaultFormat',
    'DISPID_SRRTTickCount', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE8',
    'Speech_StreamPos_Asap', 'DISPID_SRSAudioStatus', 'SREBookmark',
    'ISpRecoCategory', 'SPAUDIOSTATE', 'DISPID_SVEEnginePrivate',
    'SPEI_PHONEME', 'DISPID_SpeechLexiconWords', 'eLEXTYPE_PRIVATE10',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechDataKey', 'SVP_7',
    'SPEI_UNDEFINED', 'DISPID_SPAStartElementInResult',
    'SPINTERFERENCE_NOISE', 'SAFT32kHz16BitStereo', 'SPWF_SRENGINE',
    'SpeechTokenContext', 'SPLO_DYNAMIC', 'SPPS_SuppressWord',
    'DISPID_SASFreeBufferSpace', 'ISpStreamFormat',
    'SWPUnknownWordUnpronounceable', 'ISpeechPhraseRules',
    'ISpeechObjectToken', 'DISPID_SPPBRestorePhraseFromMemory',
    ...
    'ISpPhoneticAlphabetConverter', '_RemotableHandle',
    'SpAudioFormat', 'eLEXTYPE_APP', 'SpLexicon',
    'DISPID_SPEDisplayAttributes', 'DISPID_SOTGetStorageFileName',
    'ISpeechPhraseProperties', 'SAFT48kHz16BitMono',
    'DISPID_SVSInputWordPosition', 'SPAS_STOP',
    'DISPID_SDKDeleteValue', 'SpSharedRecoContext', 'SVP_4',
    'ISpRecognizer2', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseElement', 'DISPID_SPRuleConfidence',
    'SPSUnknown', 'SPSHORTCUTTYPE', 'STCLocalServer', 'SPRULE',
    'SAFTGSM610_22kHzMono', 'DISPID_SPRulesItem',
    'DISPID_SGRsCommitAndSave', 'SECFDefault', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechGrammarRuleState', 'SPCS_ENABLED',
    'DISPID_SVSPhonemeId', 'DISPID_SGRSTType', 'DISPID_SGRAttributes',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI_SelectionLength',
    'STSF_AppData', 'DISPID_SpeechLexicon', 'DISPID_SOTCSetId',
    'SVEVoiceChange', 'SVP_13', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SDA_Two_Trailing_Spaces', 'SAFT48kHz8BitMono',
    'SPWORDPRONOUNCEABLE', 'SPEI_RECOGNITION', 'SVEViseme',
    'DISPID_SDKGetStringValue', 'ISpeechDataKey',
    'DISPID_SVSLastResult', 'SpeechRuleAttributes',
    'DISPID_SpeechXMLRecoResult', 'eLEXTYPE_PRIVATE18',
    'ISpeechPhoneConverter', 'SpeechTokenKeyAttributes',
    'STCInprocServer', 'SVP_8', 'DISPID_SPPConfidence', 'SpMMAudioIn',
    'SpeechPropertyResponseSpeed', 'SPXRO_Alternates_SML',
    'SPLEXICONTYPE', 'SPEI_END_SR_STREAM', 'SpeechVoicePriority',
    'ISpRecoGrammar2', 'SPWT_PRONUNCIATION',
    'DISPID_SRCEInterference', 'SVP_0', 'SSTTTextBuffer',
    'SpFileStream', 'SAFTCCITT_ALaw_11kHzMono', 'SPEI_RESERVED5',
    'ISpRecoResult', 'SAFT16kHz16BitStereo', '__MIDL_IWinTypes_0009',
    'SPEI_PHRASE_START', 'DISPID_SAFGetWaveFormatEx',
    'SWPKnownWordPronounceable', 'DISPID_SRCERecognition',
    'SPPS_Verb', 'DISPID_SVSInputSentencePosition',
    'DISPID_SGRSTsItem', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE17', 'SDA_Consume_Leading_Spaces',
    'DISPID_SMSGetData', 'ISpMMSysAudio', 'DISPID_SLWWord',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGLexical', 'SPPHRASEPROPERTY',
    ...
    'ISpeechPhraseElement', 'SREStateChange',
    'SpeechPropertyComplexResponseSpeed', 'SPPROPERTYINFO',
    'IInternetSecurityMgrSite', 'SPXRO_SML',
    'DISPID_SpeechLexiconWord', 'SGRSTTEpsilon', 'ISpRecognizer3',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRRAlternates',
    'DISPID_SVSInputWordLength', '_ISpeechRecoContextEvents',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRProfile',
    'eLEXTYPE_USER_SHORTCUT', 'SPFM_CREATE', 'SpUnCompressedLexicon',
    'SECNormalConfidence', 'ISpeechPhraseRule',
    'DISPID_SPANumberOfElementsInResult', 'SpPhoneConverter',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SGRSTsCount',
    'DISPID_SGRSAddWordTransition', 'SRTEmulated',
    'DISPID_SREmulateRecognition', 'SREPropertyNumChange', 'SWTAdded',
    'DISPID_SWFEFormatTag', 'ISpeechRecognizerStatus',
    'SDA_One_Trailing_Space', 'SpNotifyTranslator',
    'DISPID_SWFEExtraData', 'DISPID_SRSNumberOfActiveRules',
    'SPCT_COMMAND', 'DISPID_SPPParent', 'SRSInactive', 'ISpeechAudio',
    'ISpNotifySink', 'SAFTDefault', 'SAFT11kHz8BitStereo', 'ISpAudio',
    ...
    'IEnumString', 'SVEAudioLevel', 'SINoSignal', 'DISPID_SGRsCount',
    'SPWAVEFORMATTYPE', 'SGDSActive', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVEBookmark', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCRecognizer', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPRules_NewEnum', 'SPPS_NotOverriden',
    'DISPID_SRGIsPronounceable', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRCEFalseRecognition', 'SREAdaptation', 'DISPID_SVVoice',
    'DISPID_SPIAudioSizeTime', 'DISPIDSPTSI_ActiveLength',
    'Speech_Max_Pron_Length', 'SPGRAMMARSTATE',
    'ISpeechPhraseReplacements', 'SpeechVoiceEvents',
    'SAFTNoAssignedFormat', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCEStartStream', 'SRERecognition', 'ISpResourceManager',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE1',
    'DISPID_SBSRead', 'SPAO_NONE', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTsItem', 'STCInprocHandler', 'SSSPTRelativeToEnd',
    'DISPID_SRCRetainedAudio', 'DISPID_SVESentenceBoundary',
    'DISPID_SPARecoResult', 'DISPID_SGRAddState',
    'DISPID_SOTIsUISupported', 'ISpXMLRecoResult', 'DISPID_SVStatus',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCERequestUI',
    'DISPID_SPEAudioSizeTime', 'SpeechPartOfSpeech',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLWsItem',
    'STCRemoteServer', 'DISPID_SPPNumberOfElements', 'SPWT_LEXICAL',
    'SSFMCreate', 'SPINTERFERENCE_TOOLOUD', 'SPEI_MAX_TTS',
    'SpeechVisemeFeature', 'SPSNotOverriden', 'DISPID_SPRuleName',
    'SPAUDIOBUFFERINFO', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPRST_ACTIVE', 'SP_VISEME_21', 'DISPID_SRCESoundStart',
    'STSF_LocalAppData', 'DISPID_SGRsDynamic',
    'ISpeechRecoResultDispatch', 'ISpeechRecognizer',
    'SPEI_SENTENCE_BOUNDARY', 'SPWT_DISPLAY',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRRDiscardResultInfo',
    'SECFNoSpecialChars', 'SREPrivate', 'SVP_6', 'SP_VISEME_18',
    'DISPID_SWFEChannels', 'DISPID_SVEViseme', 'SDTAudio',
    'SPINTERFERENCE_NONE', 'SPEI_RECO_STATE_CHANGE',
    'ISpeechGrammarRuleStateTransition',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechPhraseProperty',
    'SPSEMANTICFORMAT', 'SAFTCCITT_ALaw_44kHzStereo', 'SSTTDictation',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPPChildren',
    'DISPID_SVEAudioLevel', 'SREPhraseStart', 'SVSFNLPSpeakPunc',
    'DISPID_SOTCategory', 'ISequentialStream', 'SP_VISEME_5',
    'DISPID_SGRSTNextState', 'DISPID_SPEAudioStreamOffset',
    'SRESoundEnd', 'DISPID_SLAddPronunciation', 'ISpeechLexiconWord',
    'SSFMOpenForRead', 'SPAR_Unknown',
    'DISPID_SGRSAddSpecialTransition', 'SP_VISEME_12',
    'DISPID_SOTDisplayUI', 'DISPID_SPPs_NewEnum', 'SVEBookmark',
    'SpResourceManager', 'DISPID_SRSClsidEngine', 'DISPID_SPEsCount',
    'SpeechSpecialTransitionType', 'SDKLDefaultLocation', 'SPAS_RUN',
    'SVP_10', 'SAFTADPCM_22kHzStereo', 'SAFTGSM610_44kHzMono',
    'SVESentenceBoundary', 'SRATopLevel',
    'DISPID_SRSCurrentStreamNumber', 'SPAS_PAUSE', 'SPPS_RESERVED1',
    'DISPID_SPIGetText', 'eLEXTYPE_RESERVED8', 'SPDKL_LocalMachine',
    'SRAORetainAudio', 'DISPID_SFSOpen', 'ISpeechPhraseInfo',
    'DISPID_SPIEngineId', 'DISPID_SRGId', 'SpStreamFormatConverter',
    'SPPHRASEREPLACEMENT', 'SPPS_LMA', 'STCAll', 'SPBOOKMARKOPTIONS',
    'SPSHORTCUTPAIR', 'DISPID_SOTsCount',
    'DISPID_SOTRemoveStorageFileName', 'SPRECOSTATE', 'SPPS_Unknown',
    'SP_VISEME_20', 'SAFT32kHz8BitMono', 'SP_VISEME_0',
    'ISpProperties', 'DISPID_SRRSetTextFeedback', 'SECLowConfidence',
    'SpeechDisplayAttributes', 'SRCS_Enabled',
    'SpeechRecognizerState', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRState', 'SRADefaultToActive', 'SpCompressedLexicon',
    'SPPS_Modifier', 'DISPID_SpeechObjectTokens', 'SRSActive',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SABufferNotifySize', 'SAFTADPCM_11kHzStereo',
    'SDTAlternates', 'DISPID_SLPSymbolic', 'STSF_FlagCreate',
    'SP_VISEME_9', 'SpeechAudioState', 'SVP_16', 'eLEXTYPE_PRIVATE2',
    'ISpRecoContext', 'SAFTCCITT_ALaw_11kHzStereo', 'SPWORD',
    'DISPID_SPILanguageId', 'SPEI_VOICE_CHANGE',
    ...
    'SpeechCategoryRecoProfiles', 'ISpeechLexiconPronunciations',
    'SPFM_OPEN_READONLY', 'SpeechCategoryAudioOut', 'DISPID_SVRate',
    'SGLexicalNoSpecialChars', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRuleEngineConfidence',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechStreamSeekPositionType', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGCmdSetRuleState', 'SP_VISEME_8', 'DISPID_SPCIdToPhone',
    'ISpEventSource', 'SDKLLocalMachine', 'SAFTCCITT_ALaw_44kHzMono',
    'SSFMCreateForWrite', 'SPRECOCONTEXTSTATUS',
    'tagSPTEXTSELECTIONINFO', 'ISpeechResourceLoader',
    'DISPID_SpeechRecognizer', 'DISPID_SPAs_NewEnum', 'SVP_2',
    'SP_VISEME_13', 'SPGS_ENABLED', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SOTRemove',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT24kHz8BitMono',
    'DISPID_SDKGetlongValue', 'SPBINARYGRAMMAR', 'DISPID_SVResume',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRuleChildren',
    'DISPID_SLPPhoneIds', 'SPAR_Low', 'SASPause', 'DISPID_SAFGuid',
    'DISPID_SRCRequestedUIType', 'DISPID_SLPLangId',
    'SPDKL_DefaultLocation', 'DISPID_SRRecognizer',
    'DISPID_SLWs_NewEnum', 'DISPID_SDKOpenKey', 'ISpObjectWithToken',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLPPartOfSpeech',
    'DISPID_SLGetPronunciations', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRAudioInputStream',
    'SAFTADPCM_44kHzStereo', 'SpPhraseInfoBuilder',
    'DISPID_SPPEngineConfidence', 'SVF_None', 'SVP_11',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechFileStream',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechAudioStatus',
    'DISPID_SPPsCount', 'DISPID_SVGetVoices', 'ISpStream',
    'SASClosed', 'DISPID_SRCResume', 'DISPID_SGRSTWeight',
    'SPWORDPRONUNCIATIONLIST', 'ISpEventSink',
    'SpeechGrammarTagWildcard', 'SAFT24kHz8BitStereo',
    'SAFTADPCM_44kHzMono', 'SWPUnknownWordPronounceable',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEVENT', 'DISPID_SRRAudio', 'DISPID_SOTs_NewEnum',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechAudioBufferInfo',
    'SPCS_DISABLED', 'DISPID_SVSkip', 'SVSFParseAutodetect',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPEI_SR_BOOKMARK',
    'DISPID_SLWLangId', 'SVP_5', 'DISPID_SVGetProfiles',
    'DISPID_SpeechRecoResultTimes', 'ISpeechWaveFormatEx',
    'SGSDisabled', 'DISPID_SPIRetainedSizeBytes',
    'ISpStreamFormatConverter', 'SPEI_MIN_TTS',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCESoundEnd',
    'SAFT11kHz16BitStereo', 'SPSTREAMFORMATTYPE', 'SLODynamic',
    'DISPID_SMSALineId', 'SpeechRuleState', 'Speech_Default_Weight',
    'DISPID_SPRulesCount', 'SPRULESTATE', 'SPAUDIOSTATUS',
    'DISPID_SRCVoice', 'DISPIDSPTSI', 'SpeechVoiceCategoryTTSRate',
    'SpeechAudioFormatType', 'DISPID_SpeechAudio',
    'eWORDTYPE_DELETED', 'DISPID_SPEDisplayText', 'SVSFParseMask',
    'ISpPhoneticAlphabetSelection', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPCPhoneToId', 'SPEI_MIN_SR', 'SGRSTTDictation',
    'SpeechRecoEvents', 'DISPID_SLGetGenerationChange',
    'DISPID_SRRAudioFormat', 'SPEI_REQUEST_UI',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVGetAudioInputs', 'DISPID_SVSpeakStream',
    'SDTPronunciation', 'SpeechGrammarState', 'DISPID_SGRSTRule',
    'Speech_StreamPos_RealTime', 'DISPID_SOTDataKey',
    'SPEI_END_INPUT_STREAM', 'SPSHT_Unknown', 'ISpeechFileStream',
    'DISPID_SGRsAdd', 'STSF_CommonAppData', 'SpeechTokenShellFolder',
    'SPWORDLIST', 'SAFT22kHz16BitMono',
    'DISPID_SPIAudioStreamPosition', 'SDTProperty',
    'ISpeechGrammarRules', 'DISPID_SPIStartTime',
    'DISPID_SpeechPhraseBuilder', 'SAFTADPCM_11kHzMono'
]

_check_version('1.1.14', 1652503092.634275)
